...
static class ExtendedPlayerControl
{
    ...
    //        CustomRoles.Minion => pc.IsAlive(),
            ...
            CustomRoles.Nuker => Nuker.CanUseKillButton(pc),
            ...
            //CustomRoles.Warlock => !Warlock.isCurseAndKill.TryGetValue(pc.PlayerId, out bool wcs) || !wcs,
    ...
    public static void ResetKillCooldown(this PlayerControl player)
    {
        ...
        switch (player.GetCustomRole())
        {
            ...
            //case CustomRoles.Nuker:
                Bomber.SetKillCooldown(player.PlayerId);
                break;
            case CustomRoles.Nuker:
                Nuker.SetKillCooldown(player.PlayerId);
                break;
    ...
    public static bool KnowRoleTarget(PlayerControl seer, PlayerControl target)
    {
        ...
        else if (seer.Is(CustomRoles.Briber) && (target.Is(CustomRoles.SidekickB))) return true;
